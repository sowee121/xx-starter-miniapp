...
面向 2-3 岁半宝宝打造的微信原生亲子互动小程序。整体采用晨间草地主题、黏土软萌低饱和视觉风格，保护幼儿视觉。

功能涵盖古诗逐句点读、识字组词、数物认知与简易加减、英语短句、单韵母认读、昼夜日历认知；搭配每日趣味任务系统，完成挑战收集小动物贴纸，让幼儿在轻松游玩中完成认知探索。项目基于微信原生小程序 + 云函数开发实现。

微信后台展示名：**嘻宝星屋**。学习只增星、不扣分，无负面反馈、无广告/付费弹窗。
